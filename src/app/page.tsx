  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
        <section className="py-20 flex flex-col items-center md:flex-row">
          <div className="text-center md:w-1/2">
            <h1 className="text-5xl font-bold mb-4">Rufina Indumentaria</h1>
            <p className="text-lg mb-4">
              Explora tu estilo único con Rufina Indumentaria y refleja
              autenticidad y elegancia en cada elección.
            </p>
            ...
            <div className="flex flex-col space-y-8">
              <div className="text-center">
                ...
                <p className="mt-4 text-xl">
                  ...
                  colección de verano de Rufina. Cantidades limitadas
                  disponibles.
                </p>
